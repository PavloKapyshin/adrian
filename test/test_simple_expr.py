...
from margo import (
    ...
    defs, type_inference, default_value, std_alias, oop, simple_expr)


def compile(inp):
    pseudo_result = simple_expr.SimpleExpr(structs.Context()).main(
        oop.OOP(structs.Context()).main(
            std_alias.StdAlias(structs.Context()).main(
