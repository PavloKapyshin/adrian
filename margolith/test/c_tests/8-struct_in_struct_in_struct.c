...
struct adr_struct_Person* adr_var_johnPerson = adr_func_Person__init__(adr_var_johnId, adr_var_johnAge);
struct adr_struct_HighLevelPerson* adr_var_john = adr_func_HighLevelPerson__init__(adr_var_johnPerson);
