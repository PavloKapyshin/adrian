...
struct adr_struct_Person* adr_func_doSomethingWithJohn(struct adr_struct_Person* adr_var_john) {
struct adr_struct_Person* adr_var_myJohn = adr_func_Person__copy__(adr_var_john);
return adr_var_myJohn;
}
int main(void) {
...
struct adr_struct_Person* adr_var_anotherJohn = adr_func_doSomethingWithJohn(adr_var_secondJohn);
adr_func_Person__deinit__(adr_var_anotherJohn);
