...
*adr_t3 = *adr_u_self->adr_u_field;
adr_u_new->adr_u_field = malloc(sizeof(int_fast8_t));
*adr_u_new->adr_u_field = *adr_t3;
free(adr_t3);
return adr_u_new;
}
...
struct adr_u_Another* adr_t4 = adr_u_Another___copy__(adr_u_self->adr_u_data);
adr_u_new->adr_u_data = adr_u_Another___copy__(adr_t4);
...
*adr_t5 = 1;
struct adr_u_Another* adr_t6 = adr_u_Another___init__(adr_t5);
struct adr_u_Lol* adr_u_test = adr_u_Lol___init__(adr_t6);
int_fast8_t* adr_t7 = malloc(sizeof(int_fast8_t));
*adr_t7 = 0;
adr_u_Another___deinit__(adr_u_test->adr_u_data);
adr_u_test->adr_u_data = adr_u_Another___init__(adr_t7);
adr_u_Test___deinit__(adr_u_t);
free(adr_t1);
free(adr_t2);
free(adr_t5);
