...
PRELUDE_TYPES = (
    ...
    TYPE_PAIR, TYPE_TRIPLE, TYPE_EITHER, TYPE_RIGHT, TYPE_LEFT)
FUNC_PRINT = "print"
FUNC_LENGTH = "length"
...
PRELUDE_PROTOCOLS = (
    ...
    PROTOCOL_CONTAINER, PROTOCOL_ITERATOR)
...
CONSTANT_ARGV = "argv"
CONSTANT_UPPER_CASE_LETTERS = "upperCaseLetters"
CONSTANT_LOWER_CASE_LETTERS = "lowerCaseLetters"
PY_CONSTANTS = (
    CONSTANT_ARGV, CONSTANT_LOWER_CASE_LETTERS, CONSTANT_UPPER_CASE_LETTERS)
METHOD_SPLIT = "split"
...
PY_FUNCS = (
    ...
    FUNC_TO_LIST, FUNC_READ_FILE, FUNC_WRITE_FILE, FUNC_ASSERT, FUNC_EXIT)
...
SPEC_METHOD_ITER = "__iter__"
SPEC_METHOD_COMPONENT = "__component{}__"
OPERATOR_TO_METHOD = {
    "+": SPEC_METHOD_ADD,
    "-": SPEC_METHOD_SUB,
    "*": SPEC_METHOD_MUL,
