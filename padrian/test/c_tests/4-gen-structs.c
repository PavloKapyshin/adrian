...
struct u9b4dcfLList* i9_self = malloc(sizeof(struct u9b4dcfLList));
struct u9b4dcfSome* i9_new = malloc(sizeof(struct u9b4dcfSome));
i9_new->u9b4dcffield = IntFast8__copy__(t4->u9b4dcffield);
i9_new->type_tag = 51;
i9_self->u9b4dcfvalue = i9_new;
i9_self->type_tag = 52;
struct u9b4dcfLList* u9b4dcfhoping = i9_self;
struct u9b4dcfSome* u9b4dcfanotherHope = u9b4dcfhoping->u9b4dcfvalue;
struct u9b4dcfSome* i11_self = malloc(sizeof(struct u9b4dcfSome));
i11_self->u9b4dcffield = IntFast8__copy__(((struct u9b4dcfSome*)(u9b4dcfhoping->u9b4dcfvalue))->u9b4dcffield);
i11_self->type_tag = 51;
struct u9b4dcfSome* i11_u9b4dcfvariable = i11_self;
struct u9b4dcfSome* u9b4dcfhope = i11_u9b4dcfvariable;
