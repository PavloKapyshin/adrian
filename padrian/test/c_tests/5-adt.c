...
i8_self->type_tag = 51;
u52d71ab->f0 = i8_self;
union u52d71aMaybe* i11_new = malloc(sizeof(union u52d71aMaybe));
if (((struct u52d71aSome*)(u52d71ab->f0))->type_tag == 51) {
struct u52d71aSome* i11_i10_new = malloc(sizeof(struct u52d71aSome));
i11_i10_new->u52d71adata = IntFast8__copy__(((struct u52d71aSome*)(u52d71ab->f0))->u52d71adata);
i11_i10_new->type_tag = 51;
i11_new->f0 = i11_i10_new;
}
else if (((struct u52d71aSome*)(u52d71ab->f1))->type_tag == 52) {
i11_new->f1 = u52d71aNone__copy__(u52d71ab->f1);
}
union u52d71aMaybe* u52d71ac = i11_new;
