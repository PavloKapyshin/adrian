...
_NO_SUCH_MODULE_MEMBER = "no member {member} in module {module_name}"
...
no_such_module_member = _error_maker(
    _NO_SUCH_MODULE_MEMBER, "module_name", "member")
...
bad_expr = _error_maker(_BAD_EXPR, "expr")
