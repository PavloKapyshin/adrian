...
typedef StringIterator*pcc_auxil_t;
...
static void pcc_action_ast_0(pcc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
...
static void pcc_action_ast_1(pcc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
static void pcc_action_let_declaration_0(pcc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
...
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
    ...
    __ = LetDeclaration_new((char*)n, type, e);
    Type_free(type);
    Expr_free(e);
#undef _0e
#undef _0s
...
static void pcc_action_literal_0(pcc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define n (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_number_literal_0(pcc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
    __ = Literal_new(NumberLiteralType, (char*)_0);
#undef _0e
#undef _0s
#undef _0
#undef __
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_ast(pcc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_statement(pcc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_let_declaration(pcc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_number_literal(pcc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_ast(pcc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    {
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ast, &chunk->thunks, &(chunk->values.buf[1]))) goto L0002;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_ast_0, 2, 0);
    ...
    L0002:;
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_ast_1, 2, 0);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
        }
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_statement(pcc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_let_declaration, &chunk->thunks, &(chunk->values.buf[0]))) goto L0000;
    {
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_let_declaration(pcc_context_t *ctx) {
    ...
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0000;
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_name, &chunk->thunks, &(chunk->values.buf[0]))) goto L0000;
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0000;
    if (
    ...
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0000;
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_let_declaration_0, 2, 0);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
        thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->pos;
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_name(pcc_context_t *ctx) {
    ...
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_name_0, 0, 0);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->pos;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    }
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_expression(pcc_context_t *ctx) {
    ...
    pcc_value_table__resize(ctx->auxil, &chunk->values, 1);
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_literal, &chunk->thunks, &(chunk->values.buf[0]))) goto L0000;
    {
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_literal(pcc_context_t *ctx) {
    ...
    pcc_value_table__resize(ctx->auxil, &chunk->values, 1);
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_number_literal, &chunk->thunks, &(chunk->values.buf[0]))) goto L0000;
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_literal_0, 1, 0);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->pos;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_number_literal(pcc_context_t *ctx) {
    ...
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_number_literal_0, 0, 0);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->pos;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    }
...
int pcc_parse(pcc_context_t *ctx, void**ret) {
    ...
    if (pcc_apply_rule(ctx, pcc_evaluate_rule_ast, &thunks, ret))
